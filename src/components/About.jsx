...
const About = () => {
  return (
    <section id="about" className="about flex flex-col items-center justify-center mt-4 mb-8 mx-auto max-w-screen-xl lg:flex-row lg:justify-between lg:items-center">
